...
<head>
	...
	<link
		...
		rel="stylesheet">
	<link rel="web icon" type="png" href="<?= base_url() ?>img/icon.png" width="50">
							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										...
										<h2 class="h4 text-gray-600 mb-4">Pengaduan Masyarakat</h2>
									</div>
									...
									<div class="text-center">
										<a class="small" href="forgot-password.html">Belum punya akun ?</a>
									</div>
									<div class="text-center">
										<a class="small" href="<?= base_url() ?>auth/register">ayo buat anda sekarang!</a>
									</div>
								</div>
							</div>
						</div>
